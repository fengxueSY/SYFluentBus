...
-(void)setHeaderViewWithWidth:(CGFloat)width{
    ...
    [nextButton setImage:[UIImage imageNamed:@"next1.png"] forState:UIControlStateNormal];
   ...
   // preButton.backgroundColor=[UIColor blackColor];
    ...
    //zjh
    UIButton *closeButton = [[UIButton alloc]initWithFrame:CGRectMake(0, 310, 300, 30)];
