...
@interface FBConfirmOrderViewController ()<JF_CalendarViewDelegate,FBConfirmPayViewDelegate>{
...
-(void)getOrderPayResult:(NSNotification *)sender{
    ...
    if ([[dic objectForKey:@"WeiXinPay"] isEqualToString:@"成功"]) {
        ...
        payView.goPayButton.backgroundColor = UIColorWithRGB(230, 230, 230, 1); 
    }
