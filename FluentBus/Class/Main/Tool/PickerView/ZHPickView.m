...
//        NSString * oldDate = [NSString stringWithFormat:@"%ld-%ld-%ld",(long)[dateComponent year],(long)[dateComponent1 month],(long)[dateComponent1 day]];
        ...
        NSDate * maxDate = [formatter dateFromString:@"2900-01-01"];
...
-(UIToolbar *)setToolbarStyle{
    ...
    [button1 setTitleColor:blueUnifyColor forState:UIControlStateNormal];
    UIBarButtonItem * left1 = [[UIBarButtonItem alloc]initWithCustomView:button1];
    [button1 setTitleColor:UIColorWithRGB(200, 200, 200, 1) forState:UIControlStateNormal];
//    UIBarButtonItem *lefttem=[[UIBarButtonItem alloc] initWithTitle:@"取消" style:UIBarButtonItemStylePlain target:self action:@selector(remove)];
    ...
    [button2 setTitleColor:UIColorFromRGB(0x508cee) forState:UIControlStateNormal];
    [button2 addTarget:self action:@selector(doneClick) forControlEvents:UIControlEventTouchDown];
    [button2 setTitleColor:blueUnifyColor forState:UIControlStateNormal];
 ...
 *  设置toobar的文字颜色
 */
-(void)setHeadTintColor:(UIColor *)color{
